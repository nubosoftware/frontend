...
function fullMount(session, keys, callback) {
    ...
    if (session.nfs) {
        nfs = session.nfs.params.nfs_ip;
        nfshomefolder = session.nfs.params.nfs_path;
        nfshomefolder_slow = session.nfs.params.nfs_path_slow || session.nfs.params.nfs_path;
    } else {
        var nfsserver;
        ...
        nfshomefolder_slow = nfshomefolder;
    }

    if (session.nfs_slow) {
        nfs_slow = session.nfs_slow.params.nfs_ip;
        nfshomefolder_slow = session.nfs_slow.params.nfs_path_slow || session.nfs_slow.params.nfs_path;
    } else {
        nfs_slow = nfs;
    }
